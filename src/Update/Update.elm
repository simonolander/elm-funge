...
import Service.Blueprint.BlueprintService exposing (gotDeleteBlueprintResponse, gotLoadBlueprintByBlueprintIdResponse, gotLoadBlueprintsResponse, gotSaveBlueprintResponse)
import Service.Draft.DraftService exposing (gotDeleteDraftByIdResponse, gotLoadDraftByIdResponse, gotLoadDraftsByLevelIdResponse, gotSaveDraftResponse)
import Service.Level.LevelService exposing (gotLoadLevelByLevelIdResponse, gotLoadLevelsByCampaignIdResponse)
import Service.Solution.SolutionService exposing (gotLoadSolutionBySolutionIdResponse)
...
update msg session =
    flip CmdUpdater.batch session <|
        case msg of
            ...
            GotDeleteDraftByDraftIdResponse draftId maybeError ->
            ...
            GotLoadBlueprintResponse blueprintId result ->
                gotLoadBlueprintByBlueprintIdResponse blueprintId result
            ...
            GotLoadSolutionBySolutionIdResponse solutionId result ->
                gotLoadSolutionBySolutionIdResponse solutionId result
